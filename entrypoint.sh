...
UUID=${UUID:-'acc1d0c0-0f28-47a8-bad5-f17109f008b2'}
VMESS_WSPATH=${VMESS_WSPATH:-'/acc1d0c0-0f28-47a8-bad5-f17109f008b2-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/acc1d0c0-0f28-47a8-bad5-f17109f008b2-vless'}
